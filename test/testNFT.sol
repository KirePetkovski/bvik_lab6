...
import {lab6_NFT} from "../contract/lab6_NFT.sol";
import {Test, console} from "forge-std/Test.sol";
import {StdCheats} from "forge-std/StdCheats.sol";
import {MintBasicNft} from "../script/Interactions.s.sol";

contract testNFT is StdCheats, Test {
    string constant NFT_NAME = "Lab6_NFT";
    string constant NFT_SYMBOL = "Kire";
    BasicNft public basicNft;
    DeployBasicNft public deployer;
    address public deployerAddress;

    string public constant IMG_URI = "";
...
//
    ...
    //            keccak256(abi.encodePacked(IMG_URI))
    //    );
    //}
